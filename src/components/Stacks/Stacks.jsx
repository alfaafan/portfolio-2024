...
function Stacks() {
  return (
    <section id="stacks" className="min-h-screen p-5 lg:px-32 lg:py-12">
      ...
      <div className="py-5">
        <h2 className="my-10 text-2xl lg:text-3xl text-center uppercase font-bold">Languages</h2>
      ...
      <div className="py-5">
        <h2 className="my-10 text-2xl lg:text-3xl text-center uppercase font-bold">Frontend Tools & Frameworks</h2>
        <div className="flex flex-col justify-center content-center sm:flex-row gap-10">
          {frontend.map((stack) => (
      ...
      <div className="py-5">
        <h2 className="my-10 text-2xl lg:text-3xl text-center uppercase font-bold">Backend Tools & Frameworks</h2>
        <div className="flex flex-col justify-center content-center sm:flex-row gap-10">
          {backend.map((stack) => (
            <Card key={stack.title} title={stack.title} img={stack.img} />
          ))}
      ...
      <div className="py-5">
        <h2 className="my-10 text-2xl lg:text-3xl text-center uppercase font-bold">Other Tools</h2>
        <div className="flex flex-col justify-center content-center sm:flex-row gap-10">
          {others.map((stack) => (
            <Card key={stack.title} title={stack.title} img={stack.img} />
          ))}
